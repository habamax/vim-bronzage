...
" Last Updated: Mon Sep 27 22:15:54 2021
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi DiffChange guifg=NONE guibg=#4e4e4e gui=NONE cterm=NONE
  hi DiffText guifg=#d75f5f guibg=#303030 gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi DiffText ctermfg=167 ctermbg=236 cterm=NONE
