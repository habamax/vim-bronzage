...
" Last Updated: 10.10.2021 11:47:45
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi TabLine guifg=#808080 guibg=#4e4e4e gui=underline cterm=underline
  hi TabLineFill guifg=#808080 guibg=#262626 gui=underline cterm=underline
  hi TabLineSel guifg=#303030 guibg=#808080 gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi TabLine ctermfg=244 ctermbg=239 cterm=underline
  hi TabLineFill ctermfg=244 ctermbg=235 cterm=underline
...
" Color: colorDiffA #3A3A3A 237
" Color: colorDiffC #3A3A3A 237
" Color: colorDiffD #3A3A3A 237
