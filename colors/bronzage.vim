...
" Last Updated: Tue Oct 12 15:55:48 2021
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi TabLineFill guifg=#d0d0d0 guibg=#4e4e4e gui=NONE cterm=NONE
  hi TabLineSel guifg=#d0d0d0 guibg=#303030 gui=NONE cterm=NONE
...
if s:t_Co >= 16
  ...
  hi MatchParen ctermfg=7 ctermbg=3 cterm=NONE
  hi Search ctermfg=7 ctermbg=2 cterm=NONE
  hi IncSearch ctermfg=7 ctermbg=11 cterm=NONE
...
" Color: colorDiffA  #3A3A3A        237            0
" Color: colorDiffC  #3A3A3A        237            0
" Color: colorDiffD  #3A3A3A        237            0
" Term colors: color00 color01 color02 color11 color12 color13 color14 color07
" Term colors: color08 color09 color10 color03 color04 color05 color06 color15
" vim: et ts=2 sw=2
